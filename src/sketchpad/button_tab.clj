...
;                     :size [20 :by 20]
;                     :id :close-button
;                     :paint (partial paint-tab-button))]
;     (doto btn
...
;         label (proxy [JLabel] []
;                 (getText []
;                   (let [index (.indexOfTabComponent (@app :editor-tabbed-panel) rta)]
;                     (if (= (.getSelectedIndex (@app :editor-tabbed-panel)) i)
...
; (def btn-app sketchpad.state/app)
