...
"Show or hide the buffer tabs."
  (seesaw/config! (seesaw/select (get-in @state/app [:buffer-tabbed-panel :component :container]) [:.button-tab]) :visible? bool)
  (reset! sketchpad.config.prefs/show-tabs? bool)))
